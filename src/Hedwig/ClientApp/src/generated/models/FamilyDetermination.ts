...
export function FamilyDeterminationFromJSONTyped(json: any, ignoreDiscriminator: boolean): FamilyDetermination {
    ...
    return {
        ...
        'determinationDate': !exists(json, 'determinationDate') ? undefined : (json['determinationDate'] === null ? null : new Date(json['determinationDate'])),
...
export function FamilyDeterminationToJSON(value?: FamilyDetermination | null): any {
    ...
    return {
        ...
        'income': value.income,
        'determinationDate': value.determinationDate === undefined ? undefined : (value.determinationDate === null ? null : value.determinationDate.toISOString()),
