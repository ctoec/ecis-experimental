...
storiesOf('RadioButtonGroup_NEW', module)
	.add('RadioButtonGroup', () => {
		return (
			<RadioButtonGroup
				name="storybook-RadioButtonGroup"
				onChange={onChange}
				options={options}
	...
	.add('RadioButtonGroup with one single element expansion', () => {
		return (
			<RadioButtonGroup
				name="storybook-RadioButtonGroup-expansion"
				onChange={onChange}
	...
	.add('RadioButtonGroup with one multi element expansion', () => {
		return (
			<RadioButtonGroup
				name="storybook-RadioButtonGroup-multi-expansion"
				onChange={onChange}
	...
	.add('RadioButtonGroup with both single element expansion', () => {
		return (
			<RadioButtonGroup
				name="storybook-RadioButtonGroup-expansions"
				onChange={onChange}
