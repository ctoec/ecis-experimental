...
export default function ReportsSummary() {
  ...
  const pendingTableProps: TableProps<DeepNonUndefineable<Report>> = {
    ...
    columns: [
      ...
      {
        name: 'Due date',
        cell: ({ row }) => <td className="oec-table__cell--tabular-nums oec-table__cell--gray">{dateFormatter(row.reportingPeriod.dueAt as Date)}</td>,
  ...
  const submittedTableProps: TableProps<DeepNonUndefineable<Report>> = {
    ...
    columns: [
      ...
      {
        name: 'Date submitted',
        cell: ({ row }) => <td className="oec-table__cell--tabular-nums">{dateFormatter(row.submittedAt as Date)}</td>,
