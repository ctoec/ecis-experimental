...
import { getC4KTag, getFundingTag, getFundingTimeTag } from '../../../../utils/fundingType';
...
/*
 * IDEA: The columns that are common across this AgeGroupSection and that on the
 * main roster page could be separated into individual components for resuse.
 */
